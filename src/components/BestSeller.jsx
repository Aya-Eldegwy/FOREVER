...
const BestSeller = () => {
    ...
    <div className="my-10">
        <div className="text-center text-3xl py-3">
            ...
            <p className="w-3/4 m-auto text-xs sm:text-sm md:text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis ad ipsa laudantium nihil voluptatibus similique quaerat </p>
        </div>
